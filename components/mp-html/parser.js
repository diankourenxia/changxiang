...
parser.prototype.parse = function (content, mode) {
  if (mode == "xieyi") { // 协议富文本的一些自定义样式
    config.tagStyle.h4 = "font-size: 14px;color:#333;font-family: PingFangSC-Medium, PingFang SC;"
    config.tagStyle.h3 = "font-size: 14px;color:#333;font-family: PingFangSC-Medium, PingFang SC; padding-left: 20px;"
    config.tagStyle.h2 = "font-size: 14px;color:#333;font-family: PingFangSC-Medium, PingFang SC;"
    config.tagStyle.h1 = "font-size: 14px;color:#333;font-family: PingFangSC-Medium, PingFang SC;"
    config.tagStyle.table = "font-size: 12px; width: 100%; padding-left: 20px; padding-right: 20px; font-size:12px; color: #333; font-family: PingFangSC-Medium, PingFang SC; line-height: 20px; margin-bottom: 4px !important;"
    config.tagStyle.p = "padding-left: 20px; padding-right: 20px; font-size:12px; color: #333; font-family: PingFangSC-Medium, PingFang SC; line-height: 20px; margin-bottom: 4px !important;"
    config.tagStyle.tr = "width: 50%; padding-right: 4px;"
    config.tagStyle.td = "height: 50px; vertical-align: top"
  }
