    ...
    >
      ...
      >
        <view class="wyb-popup-slot">
          <view class="wyb-popup-title" v-if="title" :style="titleStyle">
            {{ title }}
          </view>
          <slot></slot>
        </view>
...
export default {
  data() {
    return {
      ...
      maskOpacity: 0,
      myStatusBarHeight: undefined,
      myWindowHeight: undefined,
    }
  },
  created() {
    let myGetSystemInfoSync = uni.getSystemInfoSync()
    this.w = myGetSystemInfoSync.screenWidth
    this.h = myGetSystemInfoSync.screenHeight
    this.myStatusBarHeight = myGetSystemInfoSync.statusBarHeight
    this.myWindowHeight = myGetSystemInfoSync.windowHeight
  },
  computed: {
    autoCenterTop() {
      let statusBarHeight = this.myStatusBarHeight
      let windowHeight = this.myWindowHeight
  ...
  mounted() {
    // #ifdef H5
    let winHeight = this.myWindowHeight
