	...
	<view class="home">
		...
		<view class="tabs">
		  ...
		  whiteSpace: tabList.length > 4 ? 'nowrap' : 'normal',
					...
					<view @tap="onTab(index)" v-for="(item, index) in tabList" :key="index" class="tabs_container"
						:style="{
